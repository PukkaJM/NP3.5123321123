		...
		var Bh = function (Sw) {
		  ...
		  ik = function () {
			{
			  ...
			  return (
				Object(B4.useEffect)(function () {
				  Ba('np-ui:getCars', {}).then(function (MB) {
					SP(MB.data)
					SY(MB.data)
				  })
				}, []),
		  ...
		  Sg = function () {
			var Sc = Object(B4.useState)([]),
			  ...
			  Sd = Sr[1]
			Object(B4.useEffect)(function () {
			  Ba('np-ui:getDOJData', {}).then(function (SA) {
					...
					children: Object(BG.jsx)('div', {
					  ...
					  children: Object(BG.jsx)(iX, {
						...
						onChange: function (SI) {
						  return (function (SA) {
							Ba('np-ui:setDOJStatus', { status: SA }).then(
							  function (SJ) {
